...
wellPanel(HTML('<div class="help-tip">
  ...
  wellPanel(checkboxGroupInput("entry.layer", label = "Vrstvy",
    choices = c("Mapový podklad" = "MP", "Povodí" ="P", "Horní povodí" = "HP", "Řeky" = "R", "Jezera" = "J", 
