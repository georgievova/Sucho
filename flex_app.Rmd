...
renderUI({
    absolutePanel(class = "panel panel-default", fixed = TRUE,
                draggable = FALSE, top = '2.9%', left = '3%', right = "auto", bottom = "auto",
...
absolutePanel(class = "panel panel-default", fixed = TRUE,
                  draggable = FALSE, top = '6%', left = "auto", right = '1%', bottom = "auto",
                  width = '10%',
                  style = "opacity: 1; style = z-index: 400",
...
absolutePanel(class = "panel panel-default", fixed = TRUE,
                draggable = FALSE, top = '10%', left = '8%', right = "auto", bottom = "auto",
                width = '8.3%', height = '7.5%', style = "opacity: 1; style = z-index: 400",
  wellPanel(
