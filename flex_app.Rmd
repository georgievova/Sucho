...
reac<- eventReactive(input$go1,{ 
  ...
  return(list(bilance=bilance_filtr,dta=dta, entry_min=entry_min, entry_max=entry_max))
...
output$map<-renderLeaflet({
  ...
  # map <- map %>% addPolygons(data=dta1, layerId = dta1$UPOV_ID, color = "#000066", 
  ...
  #                                            "border-color" = "rgb(255, 255, 255)"),
  #                                            textsize = "15px", direction = "auto")) %>%
  #         addPolygons(data=dta2, layerId = dta2$UPOV_ID, color = "#000066", fillColor = ~pal_1(dta2$value), 
