...
checkboxGroupInput("entry.layer_u", label = "Vrstvy",
                                                        ...
                                                        selected = c("MP", "P", "O")),
hr(),
checkboxInput("uziv_tab_user", label = "Zadání vlastních hodnot", value = FALSE))
...
passwordModal <- function(failed = FALSE) {
      modalDialog(
        title = "",
        textInput("heslo_uzivani", "Přihlaste se", value = "", width = NULL, placeholder = NULL),
...
wellPanel(
  br(),
  HTML(paste("<b>Odebrané a povolené množství 2017</b>")),
  tableOutput("odbery"),
  br(),
