...
output$map<-renderLeaflet({
  ...
  map <- map %>% addPolygons(data=dta, layerId = dta$UPOV_ID, color = "burlywood4", weight = 1.3, opacity = 0.3,
                 ...
                 highlightOptions = highlightOptions(color = "#000000", opacity = 1, fillOpacity = 0, weight = 2.3,
...
absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
    ...
    HTML('<button data-toggle="collapse" data-target="#box4" class="btn-block btn-danger">Výběr časových řad</button>'),
...
absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                  ...
                  width = '15%',
                  style = "opacity: 0.9; style = z-index: 400",
    HTML('<button data-toggle="collapse" data-target="#box5" class="btn-block btn-danger">Výběr časových řad</button>'),
...
absolutePanel(class = "panel panel-default", fixed = TRUE,
                  ...
                  width = '25%',
                  style = "opacity: 0.9; style = z-index: 400",
    HTML('<button data-toggle="collapse" data-target="#box6" class="btn-block btn-danger">Výběr časových                           řad</button>'),
...
absolutePanel(class = "panel panel-default", fixed = TRUE,
                  ...
                  width = '20%',
                  style = "opacity: 0.9; style = z-index: 400",
    HTML('<button data-toggle="collapse" data-target="#box7" class="btn-block btn-danger">Výběr časových řad</button>'),
