...
output: 
  flexdashboard::flex_dashboard:
    logo: img/logos_trans_white2.png
    orientation: rows
...
.datadir <- "s:/Odbor 210/SOUKROMÉ ADRESÁŘE/Irina/sucho_data"
# .dirM <- "M:/SC_Data2"
#.datadir <- getwd()
...
# IND <- readRDS(file.path(.datadir, "/atory/IND.rds"))
...
reac.ind <- eventReactive(input$go2,{ 
 ...
 dta <- (sp::merge(povodi, 
                   ind_dta[ind_dta$year == year(input$entry.date.ind) & (ind_dta$week+1) == (week(input$entry.date.ind)), ],
                   by="UPOV_ID"))
...
#           <p style = "width: 110px !important; position: relative;">Hodnoty zadáte kliknutím na místo odběru po přihlášení</p>
#           </div>'),
...
<div class='well well-sm inst'>
<img src="img/logo_chmu_n.png" style="height:50px" />
