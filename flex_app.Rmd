...
wellPanel(HTML('<div class="help-tip">
  ...
  radioButtons("indikatory", label=NULL, choices = c("SPI" = "A"
             # ,"SPEI" = "B", "PDSI" = "C", "SGI" = "D", "SRI" = "E", "Nedostatkové objemy" = "F"),
             # selected = "A"
             )),
...
if(input$indikatory == "A"){
    spi_d <- spi_filter %>% filter(DTM == as.Date(input$entry.date.ind))
...
# 3 - mimořádné sucho (- 2,0 a nižší)   
  ...
  return(list(spi_filter = spi_filter, dta=dta, pal = pal))
}, ignoreNULL = FALSE, ignoreInit = FALSE)
...
absolutePanel(
  class = "panel panel-default", fixed = TRUE,
                ...
                width = '9%', height = '8%', style = "opacity: 1; style = z-index: 400",
