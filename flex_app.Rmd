...
sim_stanice <- readRDS(file.path(.datadir, "webapp_data/geo_rds/E04_Vodomerne_stanice.rds"))
...
val_dta_sim <- readRDS(file.path(.datadir, "webapp_data/chmu/val_dta_sim.rds"))
...
output$rozvodnice <- renderLeaflet({
  ...
  rozvodnice <- leaflet() %>%
    ...
    addCircleMarkers(data = sim_stanice, lng = sim_stanice@coords[,1], lat = sim_stanice@coords[,2], 
                     radius = 1, color = "#000099", opacity = 1) %>% 
